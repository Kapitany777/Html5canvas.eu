...
<html>
    <head>
        ...
        <title>HTML5 Canvas - Linkek</title>
    </head>
    
    <body>
        <?php 
        PageHeader();
        PageH1("Hasznos linkek");
        ?>
        ...
        <div id="content">
            <div class="text">
                ...
                <ul class="links">
                    <li><a href="http://www.lidercfeny.hu/" target="_blank">Lidércfény Online Kulturális Magazin</a></li>
                    <li><a href="http://www.fantasybooks.hu/" target="_blank">Fantasy Books</a></li>
