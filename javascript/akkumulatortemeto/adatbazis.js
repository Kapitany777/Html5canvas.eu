const Fonevek =
    [
        ...
        "rém", "rémtett", "rémület", "rettenet", "rohamosztag", "rohamosztagos", "rom", "rothadás",
...
const Szornyek =
    [
        ...
        "bábák", "babók", "baglyok", "banyák", "bányalovak", "bányarémek", "barbárok", "barlanglakók", "behemótok", "békák", "bérgyilkosok", "bérkommentelők", "betyárok",
        "bigfootok", "biorobotok", "bogarak", "borzalmak",
        ...
        "nazgulok", "nekromanták", "nepperek", "nindzsák", "nünükék", "nutriák",
        "nyehőcék", "nyulak",
        ...
        "rapperek", "rémek", "rémhírterjesztők", "robotok", "rohamosztagosok", "rókák", "rókatündérek",
        "sámánok", "sárkányok",
...
const Rejtekhelyekben =
    [
        ...
        "kantelepen", "kápolnában", "kastélyban", "katakombában", "kenyérgyárban", "kilátóban", "kocsmában", "kolostorban", "kőbányában", "kriptában", "kunyhóban", "kútban",
...
const Jelzok =
    [
        ...
        "fej nélküli", "fejszés", "fékevesztett", "féllábú", "félszemű", "fertőzött", "földmélyi",
        ...
        "kancsal", "kárhozott", "kidülledt szemű", "kitaszított", "klónozott", "koszlott", "ködös",
...
const Foglalkozasok =
    [
        "ács", "adathalász", "adatrögzítő", "adjunktus", "admirális", "adószakértő", "agronómus", "agysebész", "aknász", "aktivista", "alkoholista", "altengernagy",
        ...
        "belső ellenőr", "bérgyilkos", "bérkommentelő", "berserker", "betyár", "bíboros", "biciklis", "bicikliőr",
        "biztonsági őr", "blogger", "bölcsész", "bolti eladó", "borász", "bíró", "bombaszakértő", "borbély", "botanikus", "buherátor", "burkoló", "búvár", "bűvész",
        "CEO", "CISO", "ceruzás", "CIA-ügynök", "cimbalmos", "citerás", "cowboy", "cukrász",
        "csatornatisztító", "csávázómester", "csillagász", "csősz",
        "dalnok", "dekoratőr", "demagóg", "dervis", "despota", "diák", "dísznövénykertész", "diszpécser", "DJ", "docens",
        ...
        "főmérnök", "főpap", "fotográfus", "futballsztár", "füvesember",
        ...
        "idegenvezető", "idegsebész", "idomár", "informatikus", "inkvizítor", "irattáros", "író",
        "jampec", "javasember", "jogász", "jogtanácsos", "juhász",
        ...
        "lélekbúvár", "lelkész", "levéltáros", "likvidátor", "logopédus",
        ...
        "pálinkakészítő", "pálinkamester", "páncélgránátos", "pap", "paraszt", "parkőr", "partizán", "pásztor", "patikus", "pék", "pénztáros", "pincemunkás", "pizzafutár", "PLC programozó",
        ...
        "sajtmester", "sámán", "samesz", "SAP tanácsadó", "séf", "sekrestyés", "seriff", "silódiszpécser", "sírásó", "smasszer", "sörgyártó", "sportoló",
        "sportoktató", "statiszta",
...
const FoglalkozasPostfixek =
    [
        ...
        "főosztályvezető",
        "igazgató",
        "mágus", "manager", "mester", "munkatárs",
        "ninja",
        "osztályvezető",
        "specialista",
...
const Jarmuvek =
    [
        ...
        "Haunebu-jával", "helikopterével", "hőlégballonjával",
        "kerti traktorjával", "Komar mopedjével", "kordéjával",
        "Ladájával", "lánctalpas traktorával", "lovaskocsijával",
        "magánrepülőgépével", "Mercedesével", "MTZ-jével",
        "Opeljével",
        "Polskijával", "Porschéjével",
        "repülő csészealjával", "repülőgépével", "Rigájával",
        "sárkányrepülőjével", "Skodájával", "Sturmgeschütz-ével", "Suzukijával",
...
const Fegyverekkel =
    [
        ...
        "ideggázzal",
        "Kalasnyikovval", "kampósbottal", "kapával", "karabéllyal", "karddal", "kaszával", "katanával", "kézigránáttal", "kiegyenesített kaszával", "konyhakéssel",
        ...
        "mankóval", "második világháborús bajonettel", "mesterlövészpuskával", "metszőollóval", "Molotov-koktéllal", "mordállyal", "muskétával",
        "nehéz csákánnyal", "nehézgéppuskával", "nyeles kézigránáttal", "nuncsakuval",
        ...
        "sarlóval", "shotgunnal", "sörétes puskával", "Steyr AUG-gal", "Sturmgewehrrel", "sugárpisztollyal", "sugárvetővel", "surikennel",
