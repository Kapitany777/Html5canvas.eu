...
const Szornyek =
    [
        ...
        "babók", "baglyok", "banyák", "bányalovak", "barbárok", "barlanglakók", "békák", "bérgyilkosok", "bérkommentelők", "bigfootok",
...
const Foglalkozasok =
    [
        ...
        "demagóg", "dervis", "despota", "diák", "diszpécser", "DJ", "docens",
        "edző", "éjjeliőr", "elektrotechnikus", "elemző", "ellentengernagy", "élmunkás", "élsportoló", "elvtárs", "erdei rabló", "erdész", "esztergályos",
        ...
        "generális", "gengszter", "gépész", "géplakatos", "géppuskás", "gerilla", "gladiátor", "gombaszakértő", "gondnok", "gránátos", "gumitalpú",
        ...
        "javasember", "jogász", "jogtanácsos",
        "kalauz", "KAM", "kantelep-vezető", "kántor", "karbantartó", "kárpitos", "kazánfűtő", "kazánkovács", "kém", "kéményseprő", "kertész", "kidobóember", "kintornás", "klímarettegő",
        ...
        "közterület-felügyelő", "kubikos", "kuruzsló", "kútfúró", "kutató",
        ...
        "radarkezelő", "raktárvezető", "rapper", "rapsztár", "recepciós", "régész", "rendész", "rendőr", "rendőrfőnök", "rendszerelemző", "rendszergazda",
        ...
        "tábornok", "táltos", "tanár", "tanársegéd", "targoncás", "tarlófelelős", "taxisofőr", "technikus", "téemkás", "tehenész", "telepvezető", "temetőcsősz", "tengeralattjárós",
        ...
        "üzemgazdász", "üzemmérnök", "üzletvezető",
        "vadász", "vadászpilóta", "vadőr", "vagyonőr", "váltókezelő", "varázsló", "vasutas", "vegyész", "vegyszerfelelős", "vérbíró", "vietkong",
        "világítótorony-őr", "villanyszerelő", "virológus",
...
const FoglalkozasPostfixek =
    [
        ...
        "osztályvezető",
        "specialista",
        "szakasszisztens", "szakbarbár", "szakember", "szakértő", "szaktanácsadó",
        "tanácsadó", "technikus"
    ];
